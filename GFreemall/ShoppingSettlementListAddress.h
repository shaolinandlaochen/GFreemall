//
//  ShoppingSettlementListAddress.h
//
...
@interface ShoppingSettlementListAddress : NSObject <NSCoding, NSCopying>
...
@property (nonatomic, assign) double listAddressIdentifier;
