...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    autoSize
        ...
        image.sd_layout.leftSpaceToView(self.contentView, 0).topSpaceToView(self.contentView, 0.5).bottomSpaceToView(self.contentView, 0.5).widthIs(180*autoSizeScaleX);
        //商品名称
